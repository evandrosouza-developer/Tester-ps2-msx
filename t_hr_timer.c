...
volatile uint64_t u64_TIM2_Cnt;										//TIM2 as uint64_t
...
void tim2_setup(void)
{
	 ...
	 */
	timer_set_prescaler(TIM2, ((rcc_apb1_frequency * 2) / 4000000) - 1);
...
void delay_qusec(uint16_t qusec, void next_step (void))
{
